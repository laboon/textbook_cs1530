TITLE=A Friendly Introduction to Software Engineering
AUTHOR=Bill Laboon
DEDICATION=For my parents, who set me on this journey
...
# Uses date of most recent commit in repo
	$(PANDOC) main.tex -o software-engineering-laboon.pdf \
